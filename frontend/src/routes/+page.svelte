	...
	<div class="container mx-auto px-4 text-center">
		...
		<div class="max-w-2xl mx-auto">
			<form action="/recherche" method="GET" class="flex">
				...
				/>
				<button type="submit" class="bg-accent hover:bg-accent/90 px-8 py-4 rounded-r-lg font-semibold transition-colors">
					Rechercher
				</button>
			</form>
		</div>
...
<section class="container mx-auto px-4 py-12">
	<h2 class="text-3xl font-bold mb-8">Parcourir par catégorie</h2>
		...
		<div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
			{#each categories as category}
				<a 
					...
					class="card hover:shadow-lg transition-shadow text-center"
				>
...
<section class="bg-gray-100 py-12">
	<div class="container mx-auto px-4">
		<div class="flex justify-between items-center mb-8">
			...
			<a href="/annonces" class="text-primary hover:underline">Voir tout</a>
		</div>
...
<section class="container mx-auto px-4 py-16">
	...
	<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
		<div class="text-center">
			...
			<p class="text-gray-600">Inscrivez-vous gratuitement en quelques secondes</p>
		</div>
		...
		<div class="text-center">
			...
			<h3 class="text-xl font-semibold mb-2">Déposez votre annonce</h3>
			<p class="text-gray-600">Ajoutez des photos et décrivez votre article</p>
		</div>
		...
		<div class="text-center">
			...
			<h3 class="text-xl font-semibold mb-2">Vendez facilement</h3>
			<p class="text-gray-600">Discutez avec les acheteurs et finalisez la vente</p>
		</div>
	</div>
</section>
